...
START_TEST(close_to_zero_test) {
  ...
  ck_assert_float_eq(s21_asin(x1), asin(x1));
  ck_assert_float_eq(s21_asin(x2), asin(x2));
}
END_TEST
...
START_TEST(positive_less_than_1) {
  ...
  ck_assert_float_eq(s21_asin(x1), asin(x1));
  ck_assert_float_eq(s21_asin(x2), asin(x2));
  ck_assert_float_eq(s21_asin(x3), asin(x3));
  ck_assert_float_eq(s21_asin(x4), asin(x4));
}
END_TEST
...
START_TEST(positive_more_than_1) {
  ...
  ck_assert_float_eq(s21_asin(x1), asin(x1));
  ck_assert_int_eq(s21_asin(x2), asin(x2));
  ck_assert_int_eq(s21_asin(x3), asin(x3));
  ck_assert_int_eq(s21_asin(x4), asin(x4));
  ck_assert_int_eq(s21_asin(x5), asin(x5));
}
END_TEST
...
START_TEST(inf_test) {
  ck_assert_int_eq(s21_asin(INFINITY), asin(INFINITY));
  ck_assert_int_eq(s21_asin(-INFINITY), asin(-INFINITY));
}
END_TEST

START_TEST(nan_test) { ck_assert_int_eq(s21_asin(NAN), asin(NAN)); }
END_TEST

Suite *suite_asin(void) {
  Suite *s = suite_create("\033[1;31m--ASIN--\033[m");
